...
$string = file_get_contents("questions_$area.json");
...
function printClientQuestionnaire($title,$area) {
  $string = file_get_contents("questions_$area.json");
  $json = json_decode($string, true);
  $i=1;
  $qnum = $json[$area]['qnum'];
...
print '<b>' . $json[$area]['Assessment'][$i]['name'] . '</b>'; 
print '<br>';
print '<br>';
print '<b>' . $json[$area]['Assessment'][$i]['part1'] . '</b>';
print '<br>';
print '</div>';
...
print '<br>';
print '<br>';
print '<b>' . $json[$area]['Assessment'][$i]['part2'] . '</b>';
print '<br>';
print '</div>';
print '<div class="column" style="width: 15%;">';
print "
...
#print "<h4 class='headerCentered'> Notes </h4>";
...
function printMaturityModel($title,$area) {
  $string = file_get_contents("questions_$area.json");
  $json = json_decode($string, true);
  $i=1;
  $qnum = $json[$area]['qnum'];
...
?>  
  ...
  <div class="tab">
<?php printOverview("Architecture","architecture");  ?>
<?php printClientQuestionnaire("Architecture","architecture");  ?>
  </div>
  <div class="tab">
<?php printOverview("Architecture","architecture");  ?>
<?php printMaturityModel("Architecture","architecture");  ?>
  </div>

  <div class="tab">
<?php printOverview("Automation","automation");  ?>
<?php printClientQuestionnaire("Automation","automation");  ?>
  </div>

  <div class="tab">
<?php printOverview("Automation","automation");  ?>
<?php printMaturityModel("Automation","automation");  ?>
  </div>
